...
#to add try a tab indent has been used at first
#for card reader i am using '/dev/ttyACM1' 1200 port
try:
	try:
	    ...
	    #ser2 = serial.Serial('/dev/ttyUSB3', 19200, timeout=0.5)
	    ser2 = serial.Serial('/dev/ttyACM2', 19200, timeout=0.5)

	    #ser3 = serial.Serial('/dev/ttyACM1', 9600, timeout=0.5)
	except Exception as e:
	    print('exception on top---:  ',e)
	    pass
